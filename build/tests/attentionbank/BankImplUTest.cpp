...
CxxTest::StaticSuiteDescription suiteDescription_BankImplUTest( "/home/yeab/Desktop/attention/tests/attentionbank/BankImplUTest.cxxtest", 287, "BankImplUTest", suite_BankImplUTest, Tests_BankImplUTest );

static class TestDescription_suite_BankImplUTest_testMiscellaneous : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_BankImplUTest_testMiscellaneous() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 321, "testMiscellaneous" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testAddAtomVtreeTruthValueBool() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 526, "testAddAtomVtreeTruthValueBool" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testAddNode() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 591, "testAddNode" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testAddLink() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 673, "testAddLink" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testIsSource() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 716, "testIsSource" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testGetHandle_bugfix1() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 738, "testGetHandle_bugfix1" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testgetSortedHandleSet() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 769, "testgetSortedHandleSet" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testGetNormalisedSTI() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 806, "testGetNormalisedSTI" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testgetHandleSetFiltered() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 840, "testgetHandleSetFiltered" ) {}
...
public:
 TestDescription_suite_BankImplUTest_testfilter() : CxxTest::RealTestDescription( Tests_BankImplUTest, suiteDescription_BankImplUTest, 881, "testfilter" ) {}
