...
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/libsexcom.so
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/libpersist-proxy.so
...
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/libforeign.so
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/libdatalog.so
...
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/libjoin.so
...
examples/c++-attentionbank/crudexample: /usr/local/lib/opencog/librule.so
...
examples/c++-attentionbank/crudexample: examples/c++-attentionbank/CMakeFiles/crudexample.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/yeab/Desktop/attention/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable crudexample"
	cd /home/yeab/Desktop/attention/build/examples/c++-attentionbank && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/crudexample.dir/link.txt --verbose=$(VERBOSE)
...
examples/c++-attentionbank/CMakeFiles/crudexample.dir/clean:
	cd /home/yeab/Desktop/attention/build/examples/c++-attentionbank && $(CMAKE_COMMAND) -P CMakeFiles/crudexample.dir/cmake_clean.cmake
